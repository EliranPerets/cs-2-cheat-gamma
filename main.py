...
#"de_dust2":{"y":3239,"x":2476,"scale":4.4}
def update_cloud_radar(entity_list,coordinates_queue,current_map):
    #global current_map
...
# -----------------------------------------------------------------------------------------------------
    while pm.overlay_loop():
                ...
                current_map_full = handle.get_current_map_name()
                current_map = current_map_full.strip("maps/.vpk")
                if cloud_radar %2==1:
                    update_cloud_radar(entity_list,coordinates_queue,current_map)
                #print(current_map)
                #print(entity_list)
