...
class Memory:
    ...
    def get_eye_angles(self, entity: Entity) -> tuple:
        return self.read_vec3(entity.pawn_ptr + OFFSETS["client"]["C_CSPlayerPawnBase"]["m_angEyeAngles"])
    ...
    def get_entities(self) -> list:
        ...
        for i in range(1, 65):
            ...
            controller_ptr = self.get_pointer(list_entry_ptr + 120 * (i & 0x1FF))
            if controller_ptr == 0:
                continue
            ...
            pawn_ptr = self.get_pointer(list_entry_ptr + 120 * (controller_pawn_ptr & 0x1FF))
            if pawn_ptr == 0:
                continue
